...
const moneyConvert = (money) => console.log(`R$ ${money.toFixed(2).replace(".", ",")}`)
const moneyConvert2 = (money) => console.log(money.toLocaleString('pt-BR', {style: 'currency', currency:'BRL'}).replace(".", ","))

moneyConvert(1.55003)
moneyConvert2(1.55003)